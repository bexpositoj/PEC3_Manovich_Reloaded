...
Si nos ponemos las gafas de Lev Manovich, podemos observar la hibridación en como establece el mundo real como escenario de juego empleando múltiples fuentes de información como tu ubicación en el mundo, los lugares cercanos a tu ubicación y la situación del clima, todo en tiempo real y de forma persistente. Es un hibrido tanto de interfaz de usuario como de formato de medio, ya que es una adaptación gamificada de un mapa del mundo con gráficos 3D, al cual se le aplican diversos algoritmos para el renderizado de sus elementos que lo componen. Cabe mencionar también el uso de la realidad aumentada para la pantalla de captura de pokemons, donde sitúa el modelo 3D de la criatura mezclado con la imagen de la cámara y mediante el giroscopio del dispositivo móvil podemos rotar la vista en los 3 ejes hasta divisar al pokémon que pretendemos capturar. 
